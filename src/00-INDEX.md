...
| 02  | `02-ARCHITECTURE.md`     | Core architecture: crate structure, ECS, sim/render split, game loop, install & source layout, development asset strategy, RA experience recreation, first runnable plan, SDK/editor architecture | You need to make any structural or code-level decision                                                             |
