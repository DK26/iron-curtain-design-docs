...
I should be honest about what this project started as: I wasn't trying to replace OpenRA. I just wanted to test new technology — see if Rust, Bevy, and LLM-assisted development could come together into something real. A proof of concept. A learning exercise. But the more I built, the more I realized that what I was making could actually serve the community. That's when I decided to take it seriously.
