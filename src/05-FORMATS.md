...
| Section                     | Topic                                                                                                   | File                                                                   |
| --------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| Binary Codecs               | MIX, SHP, LCW, TMP, PAL, AUD, VQA, VQP, WSA, FNT, CPS, ENG, LUT, DIP codec specs; TS/RA2: SHP(TS), VXL, HVA, CSF; Generals: BIG, W3D | [binary-codecs.md](formats/binary-codecs.md)                           |
...
| IronCutscene Container      | Multi-track cutscene format (.icc) — VQA video + multi-language AUD audio + timed subtitles + chapters  | [cutscene-container.md](formats/cutscene-container.md)                 |
