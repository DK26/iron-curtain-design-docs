...
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [Foundation & Core](decisions/09a-foundation.md)        | Language, framework, data formats, simulation invariants, core engine identity, crate extraction                                            | D001â€“D003, D009, D010, D015, D017, D018, D039, D063, D064, D067, D076             |
| [Networking & Multiplayer](decisions/09b-networking.md) | Network model, relay server, sub-tick ordering, community servers, ranked play, community server bundle                                     | D006â€“D008, D011, D012, D052, D055, D060, D074                                     |
| [Modding & Compatibility](decisions/09c-modding.md)     | Scripting tiers, OpenRA compatibility, UI themes, mod profiles, licensing, export, Remastered format compat                                 | D004, D005, D014, D023â€“D027, D032, D050, D051, D062, D066, D068, D075             |
| [Gameplay & AI](decisions/09d-gameplay.md)              | Pathfinding, balance, QoL, AI systems, render modes, trait-abstracted subsystems, asymmetric co-op, LLM exhibition modes, replay highlights | D013, D019, D021, D022, D028, D029, D033, D041â€“D045, D048, D054, D070, D073, D077 |
| [Community & Platform](decisions/09e-community.md)      | Workshop, telemetry, storage, achievements, governance, profiles, data portability                                                          | D030, D031, D034â€“D037, D046, D049, D053, D061                                     |
...
| ---- | --------------------------------------------------------- | ----------------------------------------------------------- |
| D001 | Language â€” Rust                                         | [Foundation](decisions/09a-foundation.md)                   |
| D002 | Framework â€” Bevy                                        | [Foundation](decisions/09a-foundation.md)                   |
| D003 | Data Format â€” Real YAML, Not MiniYAML                   | [Foundation](decisions/09a-foundation.md)                   |
| D004 | Modding â€” Lua (Not Python) for Scripting                | [Modding](decisions/09c-modding.md)                         |
| D005 | Modding â€” WASM for Power Users (Tier 3)                 | [Modding](decisions/09c-modding.md)                         |
| D006 | Networking â€” Pluggable via Trait                        | [Networking](decisions/09b/D006-pluggable-net.md)           |
| D007 | Networking â€” Relay Server as Default                    | [Networking](decisions/09b/D007-relay-default.md)           |
| D008 | Sub-Tick Timestamps on Orders                             | [Networking](decisions/09b/D008-sub-tick.md)                |
| D009 | Simulation â€” Fixed-Point Math, No Floats                | [Foundation](decisions/09a-foundation.md)                   |
| D010 | Simulation â€” Snapshottable State                        | [Foundation](decisions/09a-foundation.md)                   |
| D011 | Cross-Engine Play â€” Community Layer, Not Sim Layer      | [Networking](decisions/09b/D011-cross-engine.md)            |
| D012 | Security â€” Validate Orders in Sim                       | [Networking](decisions/09b/D012-order-validation.md)        |
| D013 | Pathfinding â€” Trait-Abstracted, Multi-Layer Hybrid      | [Gameplay](decisions/09d/D013-pathfinding.md)               |
| D014 | Templating â€” Tera                                       | [Modding](decisions/09c-modding.md)                         |
| D015 | Performance â€” Efficiency-First, Not Thread-First        | [Foundation](decisions/09a-foundation.md)                   |
...
| D039 | Engine Scope â€” General-Purpose Classic RTS              | [Foundation](decisions/09a-foundation.md)                   |
...
| D046 | Community Platform â€” Premium Content                    | [Community](decisions/09e/D046-community-platform.md)       |
...
| D051 | Engine License â€” GPL v3 with Modding Exception          | [Modding](decisions/09c-modding.md)                         |
...
| D067 | Configuration Format Split â€” TOML vs YAML               | [Foundation](decisions/09a-foundation.md)                   |
...
| D070 | Asymmetric Co-op Mode â€” Commander & Field Ops           | [Gameplay](decisions/09d/D070-asymmetric-coop.md)           |
| D071 | External Tool API â€” IC Remote Protocol (ICRP)           | [Tools](decisions/09f/D071-external-tool-api.md)            |
...
| D074 | Community Server â€” Unified Binary with Capability Flags | [Networking](decisions/09b/D074-community-server-bundle.md) |
...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------- |
| ~~P002~~ | ~~Fixed-point scale~~ â†’ **Resolved: 1024** (matches OpenRA WDist/WPos/WAngle). See `research/fixed-point-math-design.md`                                                                                                                                                                                                                                | Resolved            |
| ~~P003~~ | ~~Audio library choice + music integration design~~ â†’ **Resolved: Kira via `bevy_kira_audio`** â€” four-bus mixer (Music/SFX/Voice/Ambient), dynamic music FSM, EVA priority queue, sound pooling. See `research/audio-library-music-integration-design.md`                                                                                             | Resolved            |
| ~~P004~~ | ~~Lobby/matchmaking wire format details~~ â†’ **Resolved:** Complete lobby/matchmaking/discovery wire protocol â€” CBOR framing, 40+ message types, server discovery (HTTPS seed + mDNS), matchmaking queue, SCR credential exchange, lobbyâ†’game transition. See `research/lobby-matchmaking-wire-protocol-design.md`                                   | Resolved            |
| P007     | Non-lockstep client game loop strategy â€” keep lockstep-only `GameLoop` and add separate `FogAuthGameLoop`/`RollbackGameLoop` later, or generalize the client/game-loop boundary now? See `architecture/game-loop.md` Â§ FogAuth/Rollback, `netcode/network-model-trait.md` Â§ Additional NetworkModel Architectures                                     | M11 (Phase 7)       |
| P008     | Workshop P2P transport: uTP (BT interop, NAT-friendly), QUIC (modern TLS + multiplexing), or dual-stack? Affects tracker behavior, NAT assumptions, dependency surface, operational tooling. See `decisions/09b/D074-community-server-bundle.md` Â§ P2P transport                                                                                         | Phase 4 (M8)        |
| P009     | Official ranked speed policy â€” one globally canonical speed preset for all ranked queues (cross-community rating comparability), or community/queue-specific with rating-weight normalization? Affects spectator-delay defaults, tick-threshold consistency, cross-community Glicko-2 portability. See `decisions/09b/D060-netcode-params.md` Â§ Tier 1 | Phase 5 (M7)        |
