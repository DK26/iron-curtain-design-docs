...
├── ra-editor      # In-engine scenario/campaign editor, Game Master mode (D038, Bevy plugin)
...
| D038 | In-engine scenario editor (OFP/Eden-inspired)             | In-engine visual editor for maps AND mission logic; resolves P005; OFP/Eden-inspired with Simple/Advanced mode; includes campaign editor, Game Master mode, co-op scenario tools, game mode templates, editor onboarding; `ra-editor` crate; see `09-DECISIONS.md` § D038 for full design                                                                                                                                                                                                                                                                                                                                                                |
